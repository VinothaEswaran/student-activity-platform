...
function StudentDetail() {
  ...
  const loadActs = () => {
    api.get(`/activities/student/${id}`).then(setActivities).catch(()=>{});
  };
  ...
  const handleSave = () => {
    ...
    setLoading(true);
    api.post('/activities', {...form, studentId:parseInt(id)})
  ...
  const handleDeleteAct = (actId) => {
    ...
    api.delete(`/activities/${actId}`).then(()=>loadActs()).catch(()=>{});
  };
      ...
      {showForm && (
        <div className="form-panel">
          ...
          <div className="form-grid-new">
            ...
            <div className="field"><label>Certificate URL</label>
